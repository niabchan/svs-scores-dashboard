...
Identify strings used for:

- page, tab, section, chart, and table headings
- filters and controls
- captions, tooltips, guides, and expanders
- empty, loading, error, and warning states
- Ask Dashboard suggested questions, input guidance, answers, and feedback
- analytics and privacy explanations
...
- a tab label repeated as an identical subheader
- a heading, caption, and reading guide that restate the same idea
- repeated filter-scope explanations
- instructions that describe obvious controls
- explanatory copy that appears before the result it explains
...
- Net per Player
- full-server totals
- filtered-scope totals
- selected-player comparisons

Do not infer intent, blame, skill, behaviour, or unseen gameplay from score data.
...
- proposed change
- whether rendered verification is still needed
