...
English is the canonical source for product meaning. A translation may be more natural or longer than English, but it must preserve the same metric, scope, action, and limitation.
...
- Never describe negative contribution as intent, blame, carelessness, or poor play.
...
- wrapped filter and tab labels
- long Spanish and French instructional text
- Vietnamese diacritics and normalization
- Indonesian multi-word labels
- long player and alliance names
...
Automated tests should block:

- missing or extra locale keys
- missing locale dictionaries
- blank values
