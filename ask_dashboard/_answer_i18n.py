...
ANSWER_TEXT = {
    ...
    "id": {
        ...
        "help_text": "## Cara menggunakan Ask Dashboard\n\n1. Pilih periode SVS dan filter bilah sisi terlebih dahulu.\n2. Tanyakan tentang poin pemain atau aliansi, peringkat, pengecualian, atau kontribusi negatif.\n3. Jawaban hanya menggunakan data yang termasuk dalam filter saat ini.\n\nArea yang didukung mencakup ringkasan umum poin aliansi, pemimpin poin bersih pemain dan aliansi, kontribusi positif dibandingkan dampak negatif, pengecualian pemain, perubahan persentase negatif, kontributor teratas, dan total poin bersih setelah mengecualikan aliansi tertentu.\n\n**Contoh:**\n- Top net score player\n- Top alliance score\n- Which alliance leads net score?\n- Who contributed most in SnS?\n- What changed after excluding the selected players?\n\n**Bantuan lainnya:** `help filters`, `help questions`, `help player selection`, atau `help limitations`.\n\nAsk Dashboard menjelaskan hasil poin yang tercatat. Ask Dashboard tidak dapat menentukan motif, niat, karakter, keterampilan, strategi, tanggung jawab, atau keadaan permainan yang tidak terlihat dari data poin saja.",
